...
if __name__ == "__main__":
    # Clean up test_video.mp4 if it exists
    if os.path.exists("test_video.mp4"):
        os.remove("test_video.mp4")
        print("Deleted test_video.mp4")

    video_id = "Q46OLxFshAQ"
    transcript_path = "transcript_raw_new.txt"
    video_path = "video_low.mp4"
    screenshots_dir = r"C:\Users\USER\Desktop\Ranian's file\n8n Projects\Tutorials\Udemy\AI Builder\Action Plan\screenshots"
    ...
    if download_video(video_id, video_path):
        ...
        # remove the downloaded video file to save disk space
